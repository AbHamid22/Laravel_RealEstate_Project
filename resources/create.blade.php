...
<script>
    ...
    document.querySelector("#btnAdd").addEventListener("click", () => {
        ...
        document.querySelector("#paidamount").addEventListener("input", printCart);
        let json = {
            id: cart.length + 1,
            desc: product_name,
    ...
    document.querySelector("#btnProcess").addEventListener("click", async function() {
        ...
        const purchaseData = {
            warehouse_id: document.querySelector("#warehouse_id").value,
            vendor_id: document.querySelector("#vendor_id").value,
            purchase_date: document.querySelector("#txtPurchaseDate").value,
            delivery_date: document.querySelector("#txtDeliveryDate").value,
        ...
        try {
            const response = await fetch("http://hamid.intelsofts.com/MyLaravelProject/public/api/purchases", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                    "Accept": "application/json",
                    "X-CSRF-TOKEN": purchaseData._token
                },
