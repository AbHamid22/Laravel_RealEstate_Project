...
* ProBot Version: 3.0
* Laravel Version: 10x
* Description: This source file "resources/views/project/_edit.blade.php" was generated by ProBot AI.
...
<div class="row mb-3">
	...
	<div class="col-sm-10">
		<input type = "text" class="form-control" name="description" value="{{$project->description}}" id="description" placeholder="Description">
	</div>
</div>
<div class="row mb-3">
...
<div class="row mb-3">
	...
	<div class="col-sm-10">
		<input type = "text" class="form-control" name="budget" value="{{$project->budget}}" id="budget" placeholder="Budget">
	</div>
</div>
<div class="row mb-3">
	<label for="totat_cost" class="col-sm-2 col-form-label">Totat Cost</label>
	<div class="col-sm-10">
		<input type = "text" class="form-control" name="totat_cost" value="{{$project->totat_cost}}" id="totat_cost" placeholder="Totat Cost">
	</div>
</div>
