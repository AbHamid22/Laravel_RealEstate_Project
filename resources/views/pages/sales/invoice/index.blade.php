            ...
            <table class="table table-striped border-bottom">
                <thead class="light">
                    ...
                    <tr class="text-white dark__bg-1000">
                        <th class="border-0"> 
                            <select id="property_id" class="form-select">
...
<script>
   ...
   document.querySelector("#btnAdd").addEventListener("click",(e)=>{
       ...
       // let desc=document.querySelector("#description").value;
        ...
        let json={id:cart.length+1,desc:property_name,property_id:property_id,qty:unit,price:price,discount:discount,vat:vat,lineTotal:lineTotal};
