            ...
            <div class="top-left">
                <div class="navbar-header">
                    <a class="navbar-brand" href="{{url('/home')}}">
                        <img src="{{asset('assets/images/real.png')}}" alt="Logo">
                        <span style="color:#000;font-weight:bold;">REC&M</span>
                    </a>
                    <a class="navbar-brand hidden" href="{{url('/home')}}"><img src="{{asset('assets/images/real.png')}}" alt="Logo"></a>
                ...
                <div class="header-menu">
                    ...
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="user-avatar rounded-circle" src="{{asset('assets/images/myimg.jpg')}}" alt="User Avatar">
                        </a>
