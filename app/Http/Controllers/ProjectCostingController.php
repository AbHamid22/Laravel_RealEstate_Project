...
class ProjectCostingController extends Controller
{
	...
	{
		$projectcostings = ProjectCosting::with(['project', 'module'])->paginate(1);
	...
	public function store(Request $request)
	{
		...
		$projectcosting->status = $request->status;
		$projectcosting->remarks = $request->remarks;
		$projectcosting->created_by = $request->created_by;
		$projectcosting->updated_by = $request->updated_by;
